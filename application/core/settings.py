...
class Settings(BaseSettings):
    ...
    EMBEDDINGS_NAME: str = "openai_text-embedding-ada-002" # "huggingface_sentence-transformers/all-mpnet-base-v2"
    ...
    QDRANT_COLLECTION_NAME: Optional[str] = "data_collection"
