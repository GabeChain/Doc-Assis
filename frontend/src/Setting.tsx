...
const Setting: React.FC = () => {
  const tabs = ['常规', '提示词', '文档'];
  //const tabs = ['常规', '提示词', '文档', 'Widgets'];
...
const General: React.FC = () => {
  ...
  return (
    <div className="mt-[59px]">
      <div className="mb-4">
        <p className="font-bold text-jet dark:text-bright-gray">设置主题</p>
        <Dropdown
          options={themes}
...
const Prompts: React.FC<PromptProps> = ({
  ...
  return (
    <div className="mt-[59px]">
      <div className="mb-4">
        <p className="font-semibold dark:text-bright-gray">已选Prompt</p>
        <Dropdown
          options={prompts}
      ...
      <div className="mb-4">
        <p className="font-semibold dark:text-bright-gray">Prompt设置</p>
        <textarea
