...
from data_loader.base import BaseReader
...
class SimpleDirectoryReader(BaseReader):
    ...
    def load_data(self, concatenate: bool = False) -> List[Document]:
        ...
        #     data = FileExtractor(input_file, errors=self.errors)
        #     if isinstance(data, List):
        #         data_list.extend(data)
        #     else:
        #         data_list.append(str(data))
        #     if self.file_metadata is not None:
        #         metadata_list.append(self.file_metadata(self.job_name, str(input_file)))
        data = FileExtractor.load(self.input_dir)
        try:
            for doc in data:
                doc.metadata["title"] = self.job_name
        ...
        #     data_list.append(str(data))
        # if self.file_metadata is not None:
        #     metadata_list.append(self.file_metadata(self.job_name))
